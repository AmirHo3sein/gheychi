// apps/admin-panel/src/utils/auth-errors.ts
// Honest Persian copy for the OTP login failure modes. Mirrors provider-panel's copy (separate apps, no shared UI package) so the
