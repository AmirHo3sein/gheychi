...
export default defineConfig({
  ...
  server: {
    ...
    // turns up a NEW dependency (echarts/vue-echarts on the dashboard, markdown-it on the
    // blog editor, vue-multiselect on several filters), Vite has to re-bundle and sends a
  ...
  optimizeDeps: {
    include: ['echarts', 'vue-echarts', 'markdown-it', 'vue-multiselect'],
  },
})
