...
- **Monetization/subscription platform initiative started 2026-08-30** (spec:
  ...
  **Phase 3 (admin override + usage/plan dashboards) shipped 2026-08-30** — the
  ...
  own keys as it introduces them, rather than a hollow generic gate. Every remaining phase
  (public handle/QR, salon CRM, SMS quota, subscription coupons + billing scaffolding) is
  still unbuilt as of this note.
