...
- **Monetization/subscription platform initiative started 2026-08-30** (spec:
  ...
  **Phase 4 (public handle + QR + attribution) shipped 2026-08-30** — `salon.slug` is now
  ...
  `docs/technical-overview/31-public-handle-and-attribution.md`. Every remaining phase
  (salon CRM, SMS quota, subscription coupons + billing scaffolding) is still unbuilt as of
  this note.
