...
- **Monetization/subscription platform initiative started 2026-08-30** (spec:
  ...
  **Phase 6 (salon SMS + quota) shipped 2026-08-30** — a salon owner can send a free-text SMS
  ...
  cover it. See `docs/technical-overview/33-salon-sms-quota.md`. Every remaining phase
  (subscription coupons + billing scaffolding) is still unbuilt as of this note.
